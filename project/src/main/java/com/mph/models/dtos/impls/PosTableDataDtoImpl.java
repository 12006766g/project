...
public class PosTableDataDtoImpl implements PosTableDataDto{
	...
	public PosTableDataDtoImpl() {
		
	}

	public PosTableDataDtoImpl(String col1, String col2, String col3, String col4) {
		super();
		this.col1 = col1;
		this.col2 = col2;
		this.col3 = col3;
